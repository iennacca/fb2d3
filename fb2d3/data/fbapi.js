...
var FBDataSource = (function () {
    ...
    FBDataSource.prototype.GetFirstInfoNodePageAsync = function () {
        var def = $.Deferred();
        var nodeArray = [];
    ...
    FBDataSource.prototype.GetNextInfoNodePageAsync = function () {
        var def = $.Deferred();
        var nodeArray = [];
        def.resolve(nodeArray);
        return def.promise();
    ...
    FBDataSource.prototype.testGetInfoNodesExt = function (reply) {
        this.getToken(function (token) {
            // /me/friends?limit=10
